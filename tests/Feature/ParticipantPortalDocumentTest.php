...
class ParticipantPortalDocumentTest extends TestCase
{
 ...
 public function test_upload_review_download_and_foreign_access_are_participation_bound():void
 {
  ...
  $other=Personen::factory()->create(['typ'=>'teilnehmer']);$otherPortal=User::factory()->create(['person_id'=>$other->id]);$this->actingAs($otherPortal)->get(route('participant-portal.documents.download',$doc))->assertForbidden();
