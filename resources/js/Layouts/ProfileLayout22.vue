...
import ProfileSidebar from '@/Components/Sidebar/ProfileSidebar.vue'; // Standardmäßig importierte Sidebar
        ...
        <div class="main-wrapper">
            <div class="min-h-screen bg-gray-100">
                ...
                <div class="flex">
                    ...
                    <button @click="sidebarOpen = !sidebarOpen" class="md:hidden text-black ml-10 p-4 z-50 fixed top-0 left-0">
                        <i class="la la-bars text-2xl"></i> <!-- Icon-Größe angepasst -->
                    </button>
                    <!-- Sidebar -->
                    <slot name="sidebar">
                        <!-- Default Sidebar wenn kein Slot verwendet wird -->
                        <profile-sidebar :sidebarOpen="sidebarOpen" :activeMenu="activeMenu" :toggleMenu="toggleMenu"></profile-sidebar>
                    </slot>
