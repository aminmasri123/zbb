...
const props = defineProps({ participations: Array, bookmarks: Array, applications: Array, applicationStatuses: Array, recommendations: { type: Array, default: () => [] }, applicationDocuments: { type: Array, default: () => [] } });
