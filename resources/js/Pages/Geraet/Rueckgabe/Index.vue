...
let localRueckgaben = ref([...props.rueckgaben])
let filteredRueckgaben = ref([...localRueckgaben.value])
...
const applySearchFilter = () => {
    if (search.value) {
        filteredRueckgaben.value = localRueckgaben.value.filter(r =>
            r.rueckgabescheinNr.toString().includes(search.value)
        )
    } else {
        filteredRueckgaben.value = [...localRueckgaben.value]
    }
}
...
<tr
v-for="rueckgabe in filteredRueckgaben"
:key="rueckgabe.id"
...
<li
v-for="geraet in rueckgabe.geraete"
:key="geraet.id"
>
{{ geraet.productID }}
</li>
