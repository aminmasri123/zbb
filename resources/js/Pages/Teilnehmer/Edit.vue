    ...
    <div class="bg-gray-50 ">
        <div class="bg-gray-100  space-y-6 -mt-6">
            ...
            <div class="bg-white shadow-md rounded-xl p-4 sm:p-6 border border-gray-200">
                ...
                <Stammdaten v-if="activeTab === 'Stammdaten'" :teilnehmer="teilnehmer" :betreuer="props.betreuer" :import-details="props.participantImportDetails" :show-customer-number="Boolean(props.participantProfile.customer_number_in_stammdaten) && !props.participantProfile.enabled_tabs.includes('sozialdaten')" />
                                ...
                                <div v-if="portalEnabled && can('teilnehmer.portal.invite')">
                                    <div v-if="props.portalAccess?.account">
                                        ...
                                        <p class="mt-2 text-xs text-gray-500">
                                            Letzte Anmeldung:
                                            {{ props.portalAccess.account.portal_last_login_at ? formatDateTime(props.portalAccess.account.portal_last_login_at) : 'seit Einführung noch nicht erfasst' }}
                                        </p>
                                    </div>
                ...
                <AptitudeParticipantHistory v-else-if="activeTab === 'Eignungstests'" :participant-id="Number(teilnehmer.id)" />
                <PaSignaturesSection
...
<script setup>
    ...
    import AptitudeParticipantHistory from '@/Components/Aptitude/ParticipantHistory.vue';
...
watchEffect(() => {
  ...
  if (flash?.error) {
    ...
    const participantTabAvailable = (definition) => {
        ...
        if (definition.key === 'pa_unterschriften' && !can('anwesenheit.abrechnung')) return false;
