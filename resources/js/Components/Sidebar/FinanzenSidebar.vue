    <template  >
        <SidebarLayout>
            ...
            <!-- Fahrten Submenu -->
                <li v-if="canAny(['fahrtarten.index', 'fahrtarten.store', 'fahrtarten.update', 'fahrtkosten.index'])" class="submenu">
                    ...
                    <ul v-show="activeMenu === 'fahrten'" class="pl-6 mt-2 space-y-2">
                        <li v-if="can('fahrtarten.index')"><Link class="text-gray-400 hover:text-white transition duration-200" :href="route('fahrtarten.index')">{{$t('Fahrtarten')}}</Link></li>
                        <li v-if="can('fahrtkosten.index')"><Link class="text-gray-400 hover:text-white transition duration-200" :href="route('fahrtkosten.index')">{{$t('Fahrtkosten')}}</Link></li>
            ...
            <!-- Drucker Submenu -->
                <li v-if="canAny(['printing.index', 'printing.store', 'printing.update'])" class="submenu">
                    ...
                    <ul v-show="activeMenu === 'print'" class="pl-6 mt-2 space-y-2">
                        <li v-if="can('printing.index')"><Link class="text-gray-400 hover:text-white transition duration-200" :href="route('fahrtarten.index')">{{$t('Druckübersicht')}}</Link></li>
                    </ul>
                </li>
