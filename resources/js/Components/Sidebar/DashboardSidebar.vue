    <template  >
        <SidebarLayout>
            ...
            <li v-if="can('ai.report.use')"><Link :href="route('ai.workspace.index')" class="flex items-center gap-3 rounded-lg px-3 py-2 font-semibold"><span>✦</span><span :class="{'hidden':displayHideTextSidebar===true}">KI-Arbeitsbereich</span></Link></li>
            <!-- Dashboard Submenu -->
