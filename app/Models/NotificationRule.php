...
class NotificationRule extends Model
{
    ...
    public const CORE_EVENTS = [
        ...
        'program-feedback.created' => 'Neue Programm-Meldung',
        'program-feedback.status-changed' => 'Status einer Programm-Meldung geändert',
        'program-feedback.comment.created' => 'Neue Rückmeldung zu einer Programm-Meldung',
    ...
    private const MODULE_LABELS = [
        ...
        'it.ticket' => 'IT-Ticket',
        'it' => 'IT-Service',
        'program-feedback' => 'Programm-Feedback',
        'gruppe' => 'Gruppe',
