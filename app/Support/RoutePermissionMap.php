...
class RoutePermissionMap
{
    ...
    private const OVERRIDES = [
        ...
        'aptitude.config' => ['projekt.update', 'gruppe.store', 'teilnehmer.update'],
        'aptitude.config.save' => 'projekt.update',
        'aptitude.group' => ['teilnehmer.index', 'teilnehmer.update'],
        'aptitude.attempt.save' => 'teilnehmer.update',
        'aptitude.history' => ['teilnehmer.index', 'teilnehmer.update'],
        'aptitude.generate' => 'teilnehmer.update',
        'aptitude.generate.status' => 'teilnehmer.update',
        'daily-tasks.index' => ['teilnehmer.index', 'teilnehmer.update'],
        'daily-tasks.store' => 'teilnehmer.update',
        'daily-tasks.destroy' => 'teilnehmer.update',
        ...
        'program-feedback.destroy' => 'program-feedback.manage',
        'program-feedback.comments.store' => [],
        'program-feedback.attachments.download' => [],
        // Chat permissions are checked directly by StaffChatController so role
        // changes take effect without waiting for the permission cache.
        'chat.index' => [],
        ...
        'profile.unterweisung-signature.update' => 'user.profil',
        'profile.unterweisung-signature.destroy' => 'user.profil',
        ...
        'partner.bop.export.namensschilder' => 'gruppe.bop.export.namensschilder',
        'gruppe.bop.export.unterweisungsnachweis' => [],
        'partner.document.export' => [],
        'dokumente.pakete.store' => ['projekt.store', 'projekt.update', 'projekt.index'],
        'dokumente.pakete.update' => ['projekt.store', 'projekt.update', 'projekt.index'],
        ...
        'bop.run.timetable.generate' => 'einteilung.planning',
        'bop.run.timetable.export.excel' => 'einteilung.export',
        ...
        'teilnehmer.portal.invite' => 'teilnehmer.portal.invite',
        'teilnehmer.portal-users.index' => 'teilnehmer.portal.overview',
        'teilnehmer.portal-users' => 'teilnehmer.portal.overview',
