...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('materialanforderungs', function (Blueprint $table) {
            ...
            $table->string('bestellnummer', 100)->nullable()->index();
            $table->foreignId('standort_id')->nullable()->constrained('standorts')->restrictOnDelete();
            $table->decimal('versand_netto', 10, 2)->default(0);
            $table->decimal('versand_mwst', 5, 2)->default(19);
            $table->text('lieferant_adresse')->nullable();
            $table->string('lieferantenreferenz', 100)->nullable();
            ...
            $table->timestamp('bestellt_am')->nullable();
        });
