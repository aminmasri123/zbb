...
use App\Http\Controllers\ParticipantPortalNotificationController;
...
Route::middleware(['module:participant_portal', 'auth', 'participantPortalUser'])->group(function () {
    ...
    Route::get('/portal/benachrichtigungen', [ParticipantPortalNotificationController::class, 'index'])->name('participant-portal.notifications.index');
    Route::post('/portal/benachrichtigungen/gelesen', [ParticipantPortalNotificationController::class, 'markAllAsRead'])->name('participant-portal.notifications.read-all');
    Route::post('/portal/benachrichtigungen/{notification}/gelesen', [ParticipantPortalNotificationController::class, 'markAsRead'])->name('participant-portal.notifications.read');
    Route::put('/portal/profil', [ParticipantPortalController::class, 'updateProfile'])->name('participant-portal.profile.update')->middleware('participantPortalFeature:profile');
    Route::post('/portal/abmelden', [ParticipantPortalController::class, 'logout'])->name('participant-portal.logout');
    Route::get('/portal/jobs', [PortalJobController::class, 'index'])->name('participant-portal.jobs.index')->middleware('participantPortalFeature:job_search,application_management');
    Route::get('/portal/jobs/suche', [PortalJobController::class, 'search'])->name('participant-portal.jobs.search')->middleware(['participantPortalFeature:job_search', 'throttle:30,1']);
    Route::post('/portal/jobs/merkliste', [PortalJobController::class, 'storeBookmark'])->name('participant-portal.jobs.bookmarks.store')->middleware('participantPortalFeature:job_search');
    Route::delete('/portal/jobs/merkliste/{bookmark}', [PortalJobController::class, 'destroyBookmark'])->name('participant-portal.jobs.bookmarks.destroy')->middleware('participantPortalFeature:job_search');
    Route::post('/portal/bewerbungen', [PortalJobController::class, 'storeApplication'])->name('participant-portal.applications.store')->middleware('participantPortalFeature:application_management');
    Route::put('/portal/bewerbungen/{application}', [PortalJobController::class, 'updateApplication'])->name('participant-portal.applications.update')->middleware('participantPortalFeature:application_management');
    Route::put('/portal/bewerbungen/{application}/dokumente', [ParticipantApplicationPackageController::class, 'portalSync'])->name('participant-portal.applications.documents.sync')->middleware('participantPortalFeature:application_management');
    Route::post('/portal/bewerbungen/{application}/freigabe', [ParticipantApplicationPackageController::class, 'portalApprove'])->name('participant-portal.applications.package.approve')->middleware('participantPortalFeature:application_management');
    Route::put('/portal/stellenempfehlungen/{recommendation}/angesehen', [ParticipantJobRecommendationController::class, 'viewed'])->name('participant-portal.recommendations.viewed')->middleware('participantPortalFeature:job_search');
    Route::put('/portal/stellenempfehlungen/{recommendation}/verwerfen', [ParticipantJobRecommendationController::class, 'dismiss'])->name('participant-portal.recommendations.dismiss')->middleware('participantPortalFeature:job_search');
    Route::post('/portal/stellenempfehlungen/{recommendation}/bewerbung', [ParticipantJobRecommendationController::class, 'convert'])->name('participant-portal.recommendations.convert')->middleware('participantPortalFeature:application_management');
    Route::get('/portal/kurse', [PortalLearningController::class, 'index'])->name('participant-portal.learning.index')->middleware('participantPortalFeature:learning');
    Route::get('/portal/kurse/termine', [PortalLearningContentController::class, 'sessions'])->name('participant-portal.learning.sessions.index')->middleware('participantPortalFeature:learning');
    Route::post('/portal/kurse/{course}/einschreiben', [PortalLearningController::class, 'enroll'])->name('participant-portal.learning.enroll')->middleware('participantPortalFeature:learning');
    Route::put('/portal/kurse/einschreibung/{enrollment}/lektion/{lesson}', [PortalLearningController::class, 'updateProgress'])->name('participant-portal.learning.progress.update')->middleware('participantPortalFeature:learning');
    Route::get('/portal/kurse/material/{material}/download', [PortalLearningContentController::class, 'downloadMaterial'])->name('participant-portal.learning.materials.download')->middleware('participantPortalFeature:learning');
    Route::post('/portal/kurse/aufgaben/{assignment}/abgabe', [PortalLearningContentController::class, 'submit'])->name('participant-portal.learning.assignments.submit')->middleware('participantPortalFeature:learning');
    Route::get('/portal/kurse/abgaben/{submission}/download', [PortalLearningContentController::class, 'downloadSubmission'])->name('participant-portal.learning.submissions.download')->middleware('participantPortalFeature:learning');
    ...
    Route::get('/portal/dokumente/{document}/download', [PortalDocumentController::class, 'download'])->name('participant-portal.documents.download')->middleware('participantPortalFeature:profile');
    Route::delete('/portal/dokumente/{document}', [PortalDocumentController::class, 'destroy'])->name('participant-portal.documents.destroy')->middleware('participantPortalFeature:profile');
    Route::get('/portal/nachrichten', [ParticipantMessageController::class, 'portalIndex'])->name('participant-portal.messages.index')->middleware('participantPortalFeature:messaging');
    Route::post('/portal/nachrichten', [ParticipantMessageController::class, 'portalStore'])->name('participant-portal.messages.store')->middleware('participantPortalFeature:messaging');
    Route::put('/portal/nachrichten/teilnahme/{participation}/gelesen', [ParticipantMessageController::class, 'portalRead'])->name('participant-portal.messages.read')->middleware('participantPortalFeature:messaging');
    Route::get('/portal/einwilligungen', [PortalConsentController::class, 'index'])->name('participant-portal.consents.index')->middleware('participantPortalFeature:consents_and_approvals');
    Route::post('/portal/einwilligungen/{definition}', [PortalConsentController::class, 'act'])->name('participant-portal.consents.act')->middleware('participantPortalFeature:consents_and_approvals');
    Route::get('/portal/datenauskunft', [ParticipantDataRequestController::class, 'portalIndex'])->name('participant-portal.data-requests.index')->middleware('participantPortalFeature:profile');
    Route::post('/portal/datenauskunft', [ParticipantDataRequestController::class, 'portalStore'])->name('participant-portal.data-requests.store')->middleware('participantPortalFeature:profile');
    Route::get('/portal/datenauskunft/{dataRequest}/download', [ParticipantDataRequestController::class, 'download'])->name('participant-portal.data-requests.download')->middleware('participantPortalFeature:profile');
    ...
    Route::delete('/portal/bewerbungsstudio/dokumente/{document}', [ParticipantCareerStudioController::class, 'destroy'])->name('participant-portal.career-studio.destroy')->middleware('participantPortalFeature:application_management');
    Route::get('/portal/bewerbungsstudio/dokumente/{document}/vorschau', [ParticipantCareerStudioController::class, 'preview'])->name('participant-portal.career-studio.preview')->middleware('participantPortalFeature:application_management');
    Route::get('/portal/bewerbungsstudio/dokumente/{document}/download', [ParticipantCareerStudioController::class, 'download'])->name('participant-portal.career-studio.download')->middleware('participantPortalFeature:application_management');
    Route::get('/portal/bewerbungsstudio/dokumente/{document}/download-docx', [ParticipantCareerStudioController::class, 'downloadDocx'])->name('participant-portal.career-studio.download-docx')->middleware('participantPortalFeature:application_management');
    Route::post('/portal/bewerbungsstudio/ki-anschreiben', [ParticipantCareerStudioController::class, 'generateCoverLetter'])->name('participant-portal.career-studio.ai-cover-letter')->middleware(['participantPortalFeature:application_management', 'throttle:3,1']);
    Route::put('/portal/bewerbungen/{application}/studio-dokumente', [ParticipantApplicationDispatchController::class, 'sync'])->name('participant-portal.applications.career-documents.sync')->middleware('participantPortalFeature:application_management');
    Route::post('/portal/bewerbungen/{application}/notizen', [ParticipantApplicationDispatchController::class, 'note'])->name('participant-portal.applications.notes.store')->middleware('participantPortalFeature:application_management');
    Route::post('/portal/bewerbungen/{application}/versenden', [ParticipantApplicationDispatchController::class, 'send'])->name('participant-portal.applications.send')->middleware('participantPortalFeature:application_management');
    Route::post('/portal/lebenslauf/eintraege', [ParticipantCvController::class, 'store'])->name('participant-portal.resume.entries.store')->middleware('participantPortalFeature:profile');
    Route::put('/portal/lebenslauf/eintraege/{entry}', [ParticipantCvController::class, 'update'])->name('participant-portal.resume.entries.update')->middleware('participantPortalFeature:profile');
    Route::delete('/portal/lebenslauf/eintraege/{entry}', [ParticipantCvController::class, 'destroy'])->name('participant-portal.resume.entries.destroy')->middleware('participantPortalFeature:profile');
    Route::post('/portal/lebenslauf/versionen', [ParticipantCvController::class, 'createVersion'])->name('participant-portal.resume.versions.store')->middleware('participantPortalFeature:profile');
    Route::get('/portal/lebenslauf/versionen/{version}/download', [ParticipantCvController::class, 'download'])->name('participant-portal.resume.versions.download')->middleware('participantPortalFeature:profile');
    Route::get('/portal/lebenslauf/versionen/{version}/druck', [ParticipantCvController::class, 'print'])->name('participant-portal.resume.versions.print')->middleware('participantPortalFeature:profile');
});
...
Route::middleware(['auth', 'injectUserPermissions', 'injectUserProjekte', 'routePermission', 'configuredNotifications'])->group(function () {
    ...
    Route::middleware('module:access_management')
        ...
        ->group(function () {
            ...
            Route::put('/profile/{accessProfile}', [AccessManagementController::class, 'updateProfile'])->name('profile.update')->middleware('canStoredPermission:zutritt.stammdaten.manage');
    ...
    Route::put('/rolle/{id}/bezeichnung', [RolleController::class, 'update'])->name('rolle.update')->middleware('canAnyPermission:rolle.update,berechtigung.update');
    ...
    Route::middleware(['projectFeature:potential_analysis', 'can:potenzialanalyse.manage'])->group(function () {
        ...
        Route::delete('/potenzialanalyse/profil-kompetenzen/{kompetenz}', [PotenzialanalyseController::class, 'destroyProfilKompetenz'])->name('potenzialanalyse.profile.kompetenzen.destroy');
    ...
    Route::middleware('projectFeature:group_management')->group(function () {
        ...
        Route::get('/gruppe/{gruppe}/bop-export/teilnehmer/{personen}/auswertungsbogen-bop', [BopGruppeExportController::class, 'auswertungsbogenBopTeilnehmer'])->name('gruppe.bop.export.teilnehmer-auswertungsbogen-bop')->can('gruppe.bop.export.auswertungsbogen-bop');
        Route::get('/teilnehmer/{personen}/bop-auswertungsboegen', [BopGruppeExportController::class, 'auswertungsboegenBopPerson'])->name('teilnehmer.bop.auswertungsboegen')->middleware(['module:participant_management', 'projectFeature:participant_management', 'can:gruppe.bop.export.auswertungsbogen-bop']);
        Route::get('/gruppe/{gruppe}/bop-export/tagesauswertung', [BopGruppeExportController::class, 'tagesauswertungBop'])->name('gruppe.bop.export.tagesauswertung')->can('gruppe.bop.export.auswertungsbogen-bop');
    ...
    Route::middleware(['module:participant_management', 'projectFeature:participant_management'])->group(function () {
        ...
        Route::get('/teilnehmer/teilnahme/{participation}/berufliches-ziel', [\App\Http\Controllers\ParticipationCareerGoalController::class, 'index'])->name('teilnehmer.career-goal.index')->middleware('canAnyPermission:teilnehmer.index,teilnehmer.update');
        Route::post('/teilnehmer/teilnahme/{participation}/berufliches-ziel', [\App\Http\Controllers\ParticipationCareerGoalController::class, 'store'])->name('teilnehmer.career-goal.store')->can('teilnehmer.update');
    ...
    Route::redirect('/partner', '/organisation/partner')->name('dashboard.partner.index');
    ...
    Route::post('/bop/durchlauf/{partner}/zeitplan/excel', [BopRunController::class, 'exportTimetableExcel'])->name('bop.run.timetable.export.excel');
